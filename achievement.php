	...
	<body class="body" id="body" background="">
	  ...
	  <div class="row">
		     <div class="achievement">
		         <center><h1 class="text-primary">ACHIEVEMENTS</h1></center><hr>
		   </div>
	  </div>
	  ...
	  <?php
		          ...
		          {
			         echo"
					      <tr><th style='text-align:center' class='text-primary'>&emsp;&ensp;</th><td style='padding: 20px;'>".$result['count']."</td></tr>.<br>
					      <tr><th style='text-align:center' class='text-primary'>&emsp;&ensp;&ensp;</th><td style='padding: 20px;'>".$result['description']."</td></tr><br><br>
		  		          ";
           		  }
           		  ?>
          </div>
