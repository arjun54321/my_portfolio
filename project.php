...
<head>
	...
	<body class="body" id="body" background="">
	  ...
	  <div class="row">
		     <div class="education">
		         <center><h1 class="text-primary">PROJECT</h1></center><hr>
		   </div>
	  </div>
	  ...
	  <div class="container ">
		     <?php 
				while($result=mysqli_fetch_assoc($data))
				{
                    ...
                    echo"<div class='left col-md-3' ><img src='pic/".$name.".jpg' style='width:255px; height:255px'>
	                     <div class='overlay'>
	                     <div class='text' onClick='location.href=".$link."'>".$result['title']."</div>
	                     </div></div>";
                }
             ?>	    
	 </div>
